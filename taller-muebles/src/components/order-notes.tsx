        ...
        <div className="space-y-3">
          ...
          {!comments.length ? (
            <div className="rounded-lg border border-dashed border-stone-200 px-4 py-6 text-center">
              <MessageSquareText className="mx-auto size-5 text-stone-400" />
              <p className="mt-2 text-sm font-medium text-stone-600">Todavía no hay notas internas.</p>
              <p className="mt-1 text-xs text-stone-400">Agrega la primera actualización para el equipo.</p>
            </div>
          ) : null}
        </div>
      </div>
