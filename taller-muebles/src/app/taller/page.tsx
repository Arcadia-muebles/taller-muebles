    ...
    <AppShell active="taller" user={user}>
      ...
      <div className="mt-5">
        <OrderTable
          ...
          title="Notas activas"
          description="Notas pendientes, en producción, atrasadas o sin iniciar. Las terminadas desaparecen automáticamente."
          emptyText="No hay notas activas para producción."
        />
      </div>
